...
const Tools = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-movie", id: "tools-section", title: "" }, getTools()));
};
const Restaurants = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-games", id: "restaurants-section", title: "Popular Games" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
                ...
                id: 1,
                icon: "",
                image: "./imgs/movies/bb.jpg",
                title: ""
            }, {
                desc: "",
                id: 2,
                icon: "",
                image: "./imgs/movies/s.png",
                title: ""
            }, {
                desc: "",
                id: 3,
                icon: "",
                image: "./imgs/movies/f.jpg",
                title: ""
            }, {desc: "",
                id: 4,
                icon: "",
                image: "./imgs/movies/sv.jpg",
                title: ""
            }].map((movie) => {
            const styles = {
